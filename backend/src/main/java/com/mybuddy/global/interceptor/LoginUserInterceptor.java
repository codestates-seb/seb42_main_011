...
//            else if (requestMethod.equals("PATCH") && requestUri.startsWith(DEFAULT_URL + "/bulletin-posts")) { sendUserInfo = true; }
//            else if (requestUri.endsWith(DEFAULT_URL + "likes")) { sendUserInfo = true; }
//
//
//
//            //  ---------------------------
